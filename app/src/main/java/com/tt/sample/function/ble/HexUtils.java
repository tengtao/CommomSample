package com.tt.sample.function.ble;
...
public class HexUtils {
    ...
    private final static String TAG = "HexUtils";
    ...
    public static byte[] encrypt(byte[] src, byte[] sKey) throws Exception {
        ...
        Log.d(TAG, "加密长度==" + encrypted.length);
        //加密的转化成16进制字符串，
        return encrypted;
    }
    ...
    public static byte[] Decrypt(byte[] src, byte[] sKey) throws Exception {
        ...
        Log.d(TAG, "解密长度==" + original.length);
        return original;
    }
